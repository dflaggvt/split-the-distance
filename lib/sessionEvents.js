...
const EVENT_GROUPS = {
  ...
  ai_plan_builder_viewed: 'ai_plan',
  ai_plan_vibe_selected: 'ai_plan',
  ai_plan_generate_clicked: 'ai_plan',
  ai_plan_generated: 'ai_plan',
  ai_plan_failed: 'ai_plan',
  ai_plan_saved: 'ai_plan',
  ai_plan_copied: 'ai_plan',
  ai_plan_shared: 'ai_plan',
};
...
const EVENT_LABELS = {
  ...
  ai_plan_builder_viewed: 'Viewed AI Plan Builder',
  ai_plan_vibe_selected: 'Selected AI plan vibe',
  ai_plan_generate_clicked: 'Clicked build AI plans',
  ai_plan_generated: 'Generated AI plan',
  ai_plan_failed: 'AI plan failed',
  ai_plan_saved: 'Saved AI plan',
  ai_plan_copied: 'Copied AI plan',
  ai_plan_shared: 'Shared AI plan',
};
