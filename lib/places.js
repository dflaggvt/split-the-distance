...
const MAPBOX_TOKEN = process.env.NEXT_PUBLIC_MAPBOX_TOKEN || 'pk.eyJ1IjoiZGZsYWdnIiwiYSI6ImNtbGVtaDlycDFscDAzZnEwaXc2dWhzZWsifQ.qJb6mZWGwUNSoXf6MLJlSQ';
...
async function doMapboxCategorySearch(center, radius, mapboxCategory, categoryKey) {
  ...
  try {
    console.log(`[Mapbox] Searching ${mapboxCategory} near ${center.lat},${center.lon} | token: ${MAPBOX_TOKEN ? 'set' : 'MISSING'}`);
