  ...
  return new Promise((resolve, reject) => {
    ...
    directionsService.route(
      ...
      (result, status) => {
        ...
        // Use duration_in_traffic if available (live traffic), otherwise fall back to duration
        const totalDuration = leg.duration_in_traffic?.value || leg.duration.value; // seconds
