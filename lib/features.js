...
export const DEFAULT_FEATURES = {
  ...
  // Free, LIVE — login required, built
  group_gravity_3:    { tier: 'free',      status: 'live',        label: 'Group (3 People)',    description: 'Find the fairest meeting point for 3 friends',        emoji: '👥', enabled: true, sort_order: 11 },
  ...
  search_history:     { tier: 'free',      status: 'live',        label: 'Search History',      description: 'View and re-run your recent searches',               emoji: '🕐', enabled: true, sort_order: 14 },

  // Premium, COMING SOON — subscription required, not yet built
  drift_radius:       { tier: 'premium',   status: 'live',        label: 'Drift Radius',        description: 'See a fairness zone instead of a single point',      emoji: '🎯', enabled: true, sort_order: 20 },
  group_gravity_4plus:{ tier: 'premium',   status: 'live',        label: 'Group (4-5 People)',  description: 'Optimal meeting point for 4-5 people',                emoji: '👥', enabled: true, sort_order: 21 },
  ...
  search_history_unlimited: { tier: 'premium', status: 'live',   label: 'Unlimited History',   description: 'Keep your full search history forever',              emoji: '📚', enabled: true, sort_order: 26 },
  incremental_stops: { tier: 'premium',   status: 'live',        label: 'Road Trip Stops',     description: 'Plan stops along your route at regular intervals',   emoji: '🛣️', enabled: true, sort_order: 27 },
  ai_plan_builder:   { tier: 'free',      status: 'live',        label: 'AI Plan Builder',     description: 'Turn midpoint results into practical meetup plans',  emoji: 'AI', enabled: true, sort_order: 28 },
};
