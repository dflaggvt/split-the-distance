...
export const DEFAULT_FEATURES = {
  ...
  roulette:           { tier: 'free',      status: 'coming_soon', label: 'Midpoint Roulette',   description: 'Feeling adventurous? Let us pick a random spot',      emoji: '🎲', enabled: true, sort_order: 12 },
  ...
  roulette_unlimited: { tier: 'premium',   status: 'coming_soon', label: 'Unlimited Roulette',  description: 'Unlimited random place picks with re-rolls',         emoji: '🎰', enabled: true, sort_order: 25 },
};
